init()
{
	...
	if(getCvar("scr_mm_mapvotereplay") != "" && getCvarInt("scr_mm_mapvotereplay") > 0)
		level.mapvotereplay = true;

	level.mapvoterandom = false;
	if(getCvar("scr_mm_mapvoterandom") != "" && getCvarInt("scr_mm_mapvoterandom") > 0)
		level.mapvoterandom = true;

	level.mapvotegametype = true;
	if(getCvar("scr_mm_mapvotegametype") != "" && getCvarInt("scr_mm_mapvotegametype") == 0)
		level.mapvotegametype = false;

	level.mapvotebans = 0;
	if(getCvar("scr_mm_mapvotebans") != "" && getCvarInt("scr_mm_mapvotebans") > 0)
		level.mapvotebans = getCvarInt("scr_mm_mapvotebans");

	level.mapvotesound = false;
	if(getCvar("scr_mm_mapvotesound") != "" && getCvarInt("scr_mm_mapvotesound") > 0)
