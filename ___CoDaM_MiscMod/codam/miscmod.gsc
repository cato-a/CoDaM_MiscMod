...
_load()
{
    ...
    if(!isDefined(level.topText))
        level.topText = &"^1MiscMod ^3v3.1.2";

    level.originalBottomText = &"^1+ ^5MiscMod ^3v3.1.2";
...
_showMiscModHuds()
{
    ...
    level.miscmodversion = "^5MiscMod ^3v3.1.2";
}
// ##########
...
quick(type, response, a2, a3, a4, a5, a6, a7, a8, a9, b0, b1, b2, b3, b4, b5, b6, b7, b8, b9)
{
    ...
    if(isDefined(self.pers["mm_mute"])) {
        self iPrintLn("^3WARNING: ^7You are currently muted.");
        return;
    }
